...
<form action="<?php echo $this->action ?>" method="post" name="adminForm" onSubmit="setgood();" class="stnd form-validate">
	...
	<div class="button_wrap">
		<button type="button" class="button button_prm" onclick="submitbutton('save')">
			<?php echo JText::_('Save') ?>
		</button>
		<button type="button" class="button button_scd" onclick="submitbutton('cancel')">
