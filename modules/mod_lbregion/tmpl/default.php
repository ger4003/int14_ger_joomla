...
$clink = JRoute::_("index.php?option=com_listbingo&task=countries&Itemid=$listitemid",false);
$rlink = JRoute::_("index.php?option=com_listbingo&task=regions&Itemid=$listitemid&cid=".$c,false);
