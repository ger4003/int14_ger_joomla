...
<form action="<?php echo JRoute::_('index.php?option='.$option.'&task=ads.save&Itemid='.$listitemid); ?>" method="post"	id="adSubmitForm" name="adSubmitForm" class="form-validate" enctype="multipart/form-data">
...
<a class="gb_gallery" href="<?php echo $managelink; ?>"
	rel="moodalbox 650 400 nofollow" title="Manage Images"><?php echo JText::_('MANAGE_IMAGES');?></a>
	<?php
}
?>
</div>
