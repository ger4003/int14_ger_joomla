...
<form
	...
	?>"
	method="post" id="adSubmitForm" name="adSubmitForm" class="form-validate"
...
<a class="gb_gallery" href="<?php
			echo $managelink;
			?>"
	rel="moodalbox 650 400 nofollow" title="Manage Images"><?php
...
<small><?php
	...
	echo $descrequired;
	?>"><?php
	echo strip_tags($this->row->metadesc);
	?></textarea>
	<?php
	if ($this->params->get ( 'required_field_metadesc', 0 )) {
		?>
...
<button id="adSubmitBtn" class="gbButton validate" type="submit"><?php
echo JText::_ ( 'SAVE' );
?></button>
<?php
