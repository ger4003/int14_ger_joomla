...
$link = JRoute::_("index.php?option=$option&Itemid=$listitemid&task=ads.view&adid=".$this->row->id);
$editlink = JRoute::_("index.php?option=$option&Itemid=$listitemid&task=ads.edit&catid=".$this->row->category_id."&adid=".$this->row->id);
$closelink = JRoute::_("index.php?option=$option&Itemid=$listitemid&task=ads.close&adid=".$this->row->id);
$deletelink = JRoute::_("index.php?option=$option&Itemid=$listitemid&task=ads.remove&adid=".$this->row->id);
