...
<?php 
if((int)$this->params->get('profile_enable_image',0))
{
?>
...
<form action="<?php echo JRoute::_('index.php?option='.$option.'&task=profile.saveItemid='.$listitemid); ?>" method="post" id="josForm" name="josForm" class="form-validate" enctype="multipart/form-data">

<div>
<label id="namemsg" for="name"><?php echo JText::_('PNAME');?></label>
