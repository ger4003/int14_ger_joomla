...
<div id="el_filter" class="floattext">
  <div class="el_fleft">
      ...
      <tr>
        ...
        <td>
          <?php echo Jtext::_('From'); ?><?php echo $this->lists['date_from'];?> <?php echo Jtext::_('To'); ?><?php echo $this->lists['date_to'];?> 
        </td>
      </tr>
      <tr>
        <td>
    ...
    <?php endif; ?>
      <tr>
        <td colspan="2">
          <input type="submit" value="<?php echo JText::_('Submit Search'); ?>"/>
        </td>
      </tr>
    </table>	
  </div>
