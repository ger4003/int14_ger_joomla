...
<table class="eventtable" width="<?php echo $this->params->get('tablewidth'); ?>" border="0" cellspacing="0" cellpadding="0" summary="eventlist">
	...
	<thead>
			<tr>
				...
				?>
				<th id="el_category" class="sectiontableheader" align="left"><?php echo JHTML::_('grid.sort', $this->escape($this->params->get('catfroname')), 'c.catname', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
				<?php
				endif;
				?>
			</tr>
