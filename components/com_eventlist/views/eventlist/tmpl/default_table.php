...
<table class="eventtable" width="<?php echo $this->params->get('tablewidth', '100%'); ?>" border="0" cellspacing="0" cellpadding="0" summary="eventlist">

	<colgroup>
		<col width="<?php echo $this->params->get('datewidth', '10%'); ?>" class="el_col_date" />
		<?php if ($this->params->get('showtitle', 1) == 1) : ?>
			<col width="<?php echo $this->params->get('titlewidth', '10%'); ?>" class="el_col_title" />
		<?php endif; ?>
		<?php if ($this->params->get('showlocate', 1) == 1) :	?>
			<col width="<?php echo $this->params->get('locationwidth', '10%'); ?>" class="el_col_venue" />
		<?php endif; ?>
		<?php if ($this->params->get('showcity', 1) == 1) :	?>
			<col width="<?php echo $this->params->get('citywidth', '10%'); ?>" class="el_col_city" />
		<?php endif; ?>
		<?php if ($this->params->get('showstate', 1) == 1) :	?>
			<col width="<?php echo $this->params->get('statewidth', '10%'); ?>" class="el_col_state" />
		<?php endif; ?>
		<?php if ($this->params->get('showcat', 1) == 1) :	?>
			<col width="<?php echo $this->params->get('catfrowidth', '10%'); ?>" class="el_col_category" />
		<?php endif; ?>
		<?php if ($this->params->get('showatte', 1) == 1) :	?>
			<col width="<?php echo $this->params->get('attewidth', '10%'); ?>" class="el_col_atte" />
		<?php endif; ?>
	</colgroup>
	...
	<thead>
			<tr>
				...
				?>
				<th id="el_title" class="sectiontableheader" align="left"><?php echo JHTML::_('grid.sort', $this->escape($this->params->get('titlename', 'Title')), 'a.title', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
				<?php
				endif;
				if ($this->params->get('showlocate', 1) == 1) :
				?>
				<th id="el_location" class="sectiontableheader" align="left"><?php echo JHTML::_('grid.sort', $this->escape($this->params->get('locationname', 'Venue')), 'l.venue', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
				<?php
				endif;
				if ($this->params->get('showcity', 1) == 1) :
				?>
				<th id="el_city" class="sectiontableheader" align="left"><?php echo JHTML::_('grid.sort', $this->escape($this->params->get('cityname', 'City')), 'l.city', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
				<?php
				endif;
				if ($this->params->get('showstate', 1) == 1) :
				?>
				<th id="el_state" class="sectiontableheader" align="left"><?php echo JHTML::_('grid.sort', $this->escape($this->params->get('statename', 'State')), 'l.state', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
				<?php
				endif;
				if ($this->params->get('showcat', 1) == 1) :
				?>
				<th id="el_category" class="sectiontableheader" align="left"><?php echo $this->escape($this->params->get('catfroname', 'Type')); ?></th>
				<?php
				endif;
