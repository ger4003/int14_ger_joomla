...
<script language="javascript" type="text/javascript">
	...
	function submitbutton(pressbutton)
	{
		...
		if ( validator.validate(form.uid) === false ) {
   			alert("<?php echo JText::_( 'SELECT AN USER', true ); ?>");
   			return false;
   		} else {
			submitform( pressbutton );
   		}
...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form-validate">
	<fieldset><legend><?php echo JText::_('Details'); ?></legend>
	<table  class="admintable">
		<tr>
			...
			<td>
				...
				<a class="usermodal" title="<?php echo JText::_('Select user'); ?>" href="<?php echo $selectuser_link; ?>" rel="{handler: 'iframe', size: {x: 800, y: 500}}">
