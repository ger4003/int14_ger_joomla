...
class plgButtonInsert_attachments_token extends JPlugin
{
	...
	function onDisplay($name)
	{
		...
		AttachmentsHelper::addStyleSheet( JURI::root() . 'plugins/editors-xtd/insert_attachments_token.css' );

		// Handle RTL styling (if necessary)
		if ( $lang->isRTL() ) {
			AttachmentsHelper::addStyleSheet( JURI::root() . 'plugins/content/attachments_rtl.css' );
			AttachmentsHelper::addStyleSheet( JURI::root() . 'plugins/editors-xtd/insert_attachments_token_rtl.css' );
			}
