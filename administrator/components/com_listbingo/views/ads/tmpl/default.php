...
<tbody><tr>
	<td width="100%">
		...
		<input type="text" title="Filter by keyword" onchange="document.adminForm.submit();" class="text_area" value="<?php echo $searchtxt;?>" id="q" name="q"/>
...
<table width="100%" class="adminlist ">
	<thead>
		<tr>
			<th width="20"><input type="checkbox" name="toggle" value=""
				...
				<th width="10%"><?php echo JHTML::_('grid.sort',   JText::_('GLOBAL_ID'), 'a.globalad_id', @$this->filter->order_dir, @$this->filter->order ); ?></th>
	...
	<tr class="<?php echo "row$k"; ?>">
		...
		<td><?php echo $row->globalad_id; ?></td>
	...
	else
	{
		?>
	<tr>
		<td colspan="9"><?php echo JText::_("NO_ADS");?></td>
	</tr>
	<?php
	}
	?>
