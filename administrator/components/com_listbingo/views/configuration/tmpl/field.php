	...
	<tbody>
		...
		<tr>
			<td class="key" style="width:200px;"><span class="hasTip"
				...
				echo JText::_ ( 'Image' );
				?>::<?php
				echo JText::_ ( 'If set to  yes, images  will be displayed.' );
				?>">
						<?php
						echo JText::_ ( 'Images ' );
						?>
			...
			---
			<?php			
			//echo JHTML::_ ( 'select.booleanlist', 'config[enable_field_images]', 1, $this->config->get ( 'enable_field_images' ), JText::_ ( 'Yes' ), JText::_ ( 'No' ) );
			?>
			
			
				</td>
					<td valign="top"  align="center"><?php
			echo JHTML::_ ( 'select.booleanlist', 'config[required_field_images]', 1, $this->config->get ( 'required_field_images' ), JText::_ ( 'Yes' ), JText::_ ( 'No' ) );
			?>
