...
<table class="admintable" cellspacing="1" width="100%">
	<tbody>
		...
		<tr>
			...
			<td valign="top"><?php echo JHTML::_('select.genericlist',  $cropfrom, 'config[cropfrom_sml]', 'class="inputbox"', 'id', 'title',  $this->config->get('cropfrom_sml') );;?>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="key"><span class="hasTip"
				title="<?php echo JText::_( 'Crop from' ); ?>::<?php echo JText::_('Crop From'); ?>">
				<?php echo JText::_( 'Crop Thumbnail from' ); ?> </span></td>
			<td valign="top"><?php echo JHTML::_('select.genericlist',  $cropfrom, 'config[cropfrom_mid]', 'class="inputbox"', 'id', 'title',  $this->config->get('cropfrom_sml') );;?>
			</td>
		</tr>
		<tr>
			<td class="key"><span class="hasTip"
...
<tr>
		...
		<tr>
			...
			<td class="key"><span class="hasTip"
				title="<?php echo JText::_( 'Crop from' ); ?>::<?php echo JText::_('Crop From'); ?>">
				<?php echo JText::_( 'Crop Thumbnail from' ); ?> </span></td>
			<td valign="top"><?php echo JHTML::_('select.genericlist',  $cropfrom, 'config[cropfrom_lrg]', 'class="inputbox"', 'id', 'title',  $this->config->get('cropfrom_sml') );;?>
			</td>
		</tr>
		<tr>
			<td class="key"><span class="hasTip"
