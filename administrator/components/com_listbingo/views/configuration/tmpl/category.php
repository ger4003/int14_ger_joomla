	...
	<tbody>
		...
		<tr>
			<td class="key"><span class="hasTip"
				title="<?php echo JText::_( 'Level Depth for frontend' ); ?>::<?php echo JText::_('Level Depth for frontend'); ?>">
				<?php echo JText::_( 'Level Depth for frontend' ); ?> </span></td>
			<td valign="top"><input type="text"
				name="config[category_depth]"
				value="<?php echo $this->config->get('category_depth' );?>"
				size="10" /></td>
		</tr>
		...
		<tr>
			...
			<td valign="top"><?php echo JHTML::_('select.genericlist',  $cropfrom, 'config[category_cropfrom_sml]', 'class="inputbox"', 'id', 'title',  $this->config->get('category_cropfrom_sml') );;?>
			</td>
		</tr>
