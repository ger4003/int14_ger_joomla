  ...
  <table width="100%" class="adminlist ">
    <thead>
      <tr>
        ...
        <th class="title"><?php echo JHTML::_('grid.sort',   'title', 'name', @$this->filter->order_dir, @$this->filter->order ); ?></th>
         <th width="15%" ><?php echo JHTML::_('grid.sort',   'element', 'element', @$this->filter->order_dir, @$this->filter->order ); ?></th>
         <th width="15%" ><?php echo JHTML::_('grid.sort',   'group', 'folder', @$this->filter->order_dir, @$this->filter->order ); ?></th>
		<th width="10%" ><?php echo JHTML::_('grid.sort',   'Version', 'id', @$this->filter->order_dir, @$this->filter->order ); ?></th>
         <th width="15%" ><?php echo JHTML::_('grid.sort',   'Author', 'id', @$this->filter->order_dir, @$this->filter->order ); ?></th>
    ...
    <tr class="<?php echo "row$k"; ?>">
     ...
     <td><?php echo $row->folder; ?></td>
     		<td><?php echo empty($row->version)?'':$row->version; ?></td>
