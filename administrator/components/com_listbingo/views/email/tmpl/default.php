...
<form name="adminForm" id="adminForm" action="index.php" method="post">
  ...
  <table width="80%" cellpadding="5" class="admintable">
    <tr>
      ...
      <td width="84%" ><input name="subject" type="text" class="inputbox" id="subject" value="<?php echo $this->row->subject; ?>" size="45"/></td>
    </tr>
     <tr>
  ...
  <table width="100%" cellpadding="5" class="admintable">
    <tr>
      ...
      <td  ><input name="from_name" type="text" class="inputbox" id="from_name" value="<?php echo $this->row->from_name; ?>" size="25"/></td>
    </tr>
     <tr>
    <td valign="top" class="key"><?php echo JText::_("FROM_EMAIL");?></td>
      <td><input name="from_email" type="text" class="inputbox" id="from_email" value="<?php echo $this->row->from_email; ?>" size="25"/></td>
    </tr>
    <tr>
    <td valign="top" class="key"><?php echo JText::_("REPLY_TO");?></td>
      <td><input name="reply_to" type="text" class="inputbox" id="reply_to" value="<?php echo $this->row->reply_to; ?>" size="25"/></td>
    </tr>
    <tr>
    <td valign="top" class="key"><?php echo JText::_("REPLY_TO_EMAIL");?></td>
      <td><input name="reply_to_email" type="text" class="inputbox" id="reply_to_email" value="<?php echo $this->row->reply_to_email; ?>" size="25"/></td>
    </tr>
