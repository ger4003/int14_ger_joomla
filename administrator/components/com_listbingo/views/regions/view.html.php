...
class ListbingoViewRegions extends GView {
	function display($tpl = null) {
		...
		$filter->published = JRequest::getInt ( 'lb_filterpublished', -1);
		...
		$lists ['published'] = JHTML::_ ( 'select.genericlist', $status, 'lb_filterpublished', 'class="inputbox"', 'id', 'title', $filter->published );
