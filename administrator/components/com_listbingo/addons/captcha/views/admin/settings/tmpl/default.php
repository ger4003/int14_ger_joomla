...
<table class="admintable" cellspacing="1">
	<tbody>
		...
		<tr>
			<td class="key"><span class="hasTip"
				title="<?php echo JText::_( 'ENABLE_AJAX_CAPTCHA' ); ?>::<?php echo JText::_('ENABLE_AJAX_CAPTCHA'); ?>">
				<?php echo JText::_( 'ENABLE_AJAX_CAPTCHA' ); ?> </span></td>
			<td valign="top"><?php echo JHTML::_('select.booleanlist' , 'config[enable_ajaxcaptcha]' , null ,  $this->config->get('enable_ajaxcaptcha') , JText::_('Yes') , JText::_('No') ); ?>
			</td>
		</tr>
...
<table class="admintable" cellspacing="1">
	...
	<tr>
		<td class="key"><span class="hasTip"
			title="<?php echo JText::_( 'MESSAGE' ); ?>::<?php echo JText::_('MESSAGE'); ?>">
			<?php echo JText::_( 'MESSAGE' ); ?> </span></td>
		<td valign="top"><input type="text"
			name="config[text_captcha_msg]"
			value="<?php echo $this->config->get('text_captcha_msg' );?>"
			size="45" /></td>
	</tr>
...
<table class="admintable" cellspacing="1">
	...
	<tr>
		<td class="key"><span class="hasTip"
			...
			<?php echo JText::_( 'MESSAGE' ); ?> </span></td>
		<td valign="top"><input type="text"
			name="config[math_captcha_msg]"
			value="<?php echo $this->config->get('math_captcha_msg' );?>"
			size="45" /></td>
	</tr>
