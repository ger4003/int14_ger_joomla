...
<input name="contact_name" type="text" id="contact_name" value="<?php echo $this->currentuser->guest?'':$this->currentuser->get('name');?>"class="reply_inputtext required" size="47"/><br />

<label id="contact_emailmsg" for="contact_email"><?php echo JText::_('YOUR_EMAIL');?></label>
<input name="contact_email" type="text" id="contact_email" value="<?php echo $this->currentuser->guest?'':$this->currentuser->get('email');?>" class="reply_inputtext required validate-email"  size="47"/><br />
...
<input type="hidden" name="ad_id" value="<?php echo $this->ad->id.":".$this->ad->alias;?>" /> 
