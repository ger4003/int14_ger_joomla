...
{
	$link = JRoute::_("index.php?option=$option&task=addons.pms.front.displayComposeBox&adid=".$adid."&format=raw&Itemid=$listitemid");	
	
	$pmsrel = "rel = \"moodalbox $pmswidth $pmsheight\"";
}
else
{
	$link = JRoute::_("index.php?option=$option&task=addons.pms.front.displayComposeBox&adid=$adid&Itemid=$listitemid");
	$pmsrel = "";
}
