...
class GControllerPms_My extends GAddonsController {
	...
	function remove() {
		...
		if ($user->guest) {
			$returnurl = base64_encode ( JRoute::_ ( "index.php?option=$option&task=addons.pms.my&time=" . time (), false ) );
		...
		$link = JRoute::_ ( "index.php?option=$option&task=addons.pms.my&time=" . time (), false );
