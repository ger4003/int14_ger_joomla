...
<label id="emailmsg" for="email"><?php echo JText::_('FLAG_EMAIL');?></label>
<input name="email" type="text" id="email" class="flag_inputtext required validate-email" size="46" /><br />
