...
if (file_exists ( JPATH_ADMINISTRATOR.DS."components".DS."$option".DS."elements".DS."lbarticle.php"))
{
	$element = new JElementLbArticle(); 
}
else
{
	...
	<tbody>
		...
		<tr>
			<td class="key"><span class="hasTip"
				title="<?php echo JText::_( 'ENABLE_FOR_GUEST' ); ?>::<?php echo JText::_('ENABLE_FOR_GUEST'); ?>">
				<?php echo JText::_( 'ENABLE_FOR_GUEST' ); ?> </span></td>
			<td valign="top"><?php echo JHTML::_('select.booleanlist' , 'config[enable_flag_for_guest]' , null ,  $this->config->get('enable_flag_for_guest') , JText::_('Yes') , JText::_('No') ); ?>
			</td>
		</tr>
...
<div class="col width-50">
<fieldset class="adminform"><legend><?php echo JText::_( 'FLAG_CRITERIA' ); ?></legend>
<table class="admintable" cellspacing="1">
<tr>
	<td class="key"><span class="hasTip"
		title="<?php echo JText::_( 'CRITERIA' ); ?>::<?php echo JText::_('CRITERIA'); ?>">
		<?php echo JText::_( 'CRITERIA' ); ?>
		<br />
		(<?php echo JText::_('SEPERATE_CRITERIA');?>)
		</span></td>
	<td valign="top"><textarea name="config[flag_criteria]" cols="30"
		rows="10"><?php echo $this->config->get('flag_criteria');?></textarea>
	</td>
</tr>
</table>
</fieldset>
